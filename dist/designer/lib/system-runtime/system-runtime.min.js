...
function invalidPropertyType(propertyName, type, property) {
    debugger;getLogger().warn("invalid type for property '" + propertyName + "': expected type '" + type + "' instead of type '" + typeof property + "'");
}
...
function isValidSchema(object, schema) {
    ...
    if (hasType(object, 'object')) {
        ...
        result = false;
        debugger;$log.invalidPropertyFormat(object);
    }
